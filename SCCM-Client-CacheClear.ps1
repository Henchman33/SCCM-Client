...
.EXAMPLE
.\SCCM-Client-CacheClear.ps1 -Detect

.EXAMPLE
.\SCCM-Client-CacheClear.ps1 -Clean

.EXAMPLE
.\SCCM-Client-CacheClear.ps1 -Help

.EXAMPLE
.\SCCM-Client-CacheClear.ps1-Clean -Days 14

.EXAMPLE
.\SCCM-Client-CacheClear.ps1 -Detect -Days 14
...
function Show-Help {
    @"
Usage: .\SCCM-Client-CacheClear.ps1 [-Detect] [-Clean] [-Help] [-Days ##]
...
Examples:
  ...
  .\SCCM-Client-CacheClear.ps1 -Clean
  .\SCCM-Client-CacheClear.ps1 -Help
  .\SCCM-Client-CacheClear.ps1 -Clean -Days 30
  .\SCCM-Client-CacheClear.ps1 -Detect -Days 60
"@
}
